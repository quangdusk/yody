...
const Heading = css`
  color: ${props =>
    props.color ? style.color[props.color].default : style.color.charcoal};
...
const Sans = css`
  ...
  font-weight: ${props =>
    props.bold ? style.fontweight.sansbold : style.fontweight.sans};
`;
...
const Serif = css`
  ...
  font-style: italic;
  font-weight: ${props =>
    props.bold ? style.fontweight.serifbold : style.fontweight.serif};
`;
