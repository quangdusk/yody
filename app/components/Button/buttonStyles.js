...
export const Button = css`
  background-color: ${props =>
    props.color ? style.color[props.color].default : style.color.gray.default};
  border: ${props =>
    props.color
      ? `2px solid ${style.color[props.color].default}`
  ...
  &:hover {
    background-color: ${props =>
    props.color ? style.color[props.color].hover : style.color.gray.hover};
    border: ${props =>
    props.color
      ? `2px solid ${style.color[props.color].hover}`
